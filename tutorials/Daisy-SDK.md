...
Daisy SDK is the most direct. It is designed to be used within your project's existing frontend. This guide will go through creating a subscription signup flow, token approval flow, and [cancellation flow](#Cancellation).
...
---
### <a id="ApprovalStep "></a>Approval Step
